import { PreprocessorGroup, Processed, TransformerArgs, TransformerOptions, Options } from './types';
...
export declare const runTransformer: (name: string, options: TransformerOptions, { content, map, filename, attributes }: TransformerArgs<any>) => Promise<Processed>;
