...
class LSAndTSDocResolver {
    constructor(docManager, workspaceUris) {
    ...
    getLSForPath(path) {
        return service_1.getLanguageServiceForPath(path, this.workspaceUris, this.createDocument);
    }
    getLSAndTSDoc(document) {
        const lang = service_1.getLanguageServiceForDocument(document, this.workspaceUris, this.createDocument);
    ...
    getTSService(filePath) {
        return service_1.getService(filePath, this.workspaceUris, this.createDocument);
    }
}
