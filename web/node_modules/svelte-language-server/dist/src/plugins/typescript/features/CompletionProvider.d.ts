...
import { CompletionContext, Position, TextDocumentIdentifier, TextEdit } from 'vscode-languageserver';
...
export declare class CompletionsProviderImpl implements CompletionsProvider<CompletionEntryWithIdentifer> {
    ...
    codeActionChangeToTextEdit(doc: Document, fragment: SvelteSnapshotFragment, change: ts.TextChange, isImport: boolean): TextEdit;
    ...
    private changeSvelteComponentImport;
}
