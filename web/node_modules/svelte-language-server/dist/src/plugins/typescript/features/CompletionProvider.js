...
class CompletionsProviderImpl {
    ...
    getCompletionDocument(compDetail) {
        ...
        const documentation = tsDocumentation
            ? { value: typescript_1.default.displayPartsToString(tsDocumentation), kind: vscode_languageserver_1.MarkupKind.Markdown }
            : undefined;
        return {
            documentation,
            detail,
    ...
    changeSvelteComponentImport(importText) {
