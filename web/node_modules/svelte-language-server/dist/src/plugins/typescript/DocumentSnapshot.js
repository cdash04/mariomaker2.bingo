...
(function (DocumentSnapshot) {
    ...
    function fromDocument(document, options) {
        const { tsxMap, text, exportedNames, componentEvents, parserError, nrPrependedLines, scriptKind, } = preprocessSvelteFile(document, options);
        return new SvelteDocumentSnapshot(document, parserError, scriptKind, text, nrPrependedLines, exportedNames, componentEvents, tsxMap);
    }
     ...
     */
    function fromFilePath(filePath, options) {
        var _a;
        const originalText = (_a = typescript_1.default.sys.readFile(filePath)) !== null && _a !== void 0 ? _a : '';
        if (utils_2.isSvelteFilePath(filePath)) {
            return fromDocument(new documents_1.Document(utils_1.pathToUrl(filePath), originalText), options);
        }
        else {
...
function preprocessSvelteFile(document, options) {
    ...
    try {
        const tsx = svelte2tsx_1.default(text, {
        ...
        const start = {
            line: (_g = ((_f = e.start) === null || _f === void 0 ? void 0 : _f.line) - 1) !== null && _g !== void 0 ? _g : 0,
            character: (_j = (_h = e.start) === null || _h === void 0 ? void 0 : _h.column) !== null && _j !== void 0 ? _j : 0,
        };
...
class SvelteDocumentSnapshot {
    constructor(parent, parserError, scriptKind, text, nrPrependedLines, exportedNames, componentEvents, tsxMap) {
        this.parent = parent;
    ...
    getEvents() {
        var _a;
        return ((_a = this.componentEvents) === null || _a === void 0 ? void 0 : _a.getAll()) || [];
    }
    async getFragment() {
        if (!this.fragment) {
            const uri = utils_1.pathToUrl(this.filePath);
            this.fragment = new SvelteSnapshotFragment(await this.getMapper(uri), this.text, this.parent, uri);
        }
    ...
    async getMapper(uri) {
        ...
        return new DocumentMapper_1.ConsumerDocumentMapper(await new source_map_1.SourceMapConsumer(this.tsxMap), uri, this.nrPrependedLines);
    }
}
