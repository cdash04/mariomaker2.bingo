...
function getLanguageServiceForPath(path, workspaceUris, createDocument) {
...
function getLanguageServiceForDocument(document, workspaceUris, createDocument) {
    return getService(document.getFilePath() || '', workspaceUris, createDocument).updateDocument(document);
}
exports.getLanguageServiceForDocument = getLanguageServiceForDocument;
function getService(path, workspaceUris, createDocument) {
