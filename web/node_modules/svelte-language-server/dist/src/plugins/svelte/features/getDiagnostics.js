...
async function tryGetDiagnostics(document, svelteDoc, settings) {
    ...
    try {
        ...
        return (await createParserErrorDiagnostic(err, document)).map((diag) => documents_1.mapObjWithRangeToOriginal(transpiled, diag));
    }
}
/**
...
function getStyleErrorDiagnostics(error, document) {
    ...
    function getStyleErrorMessage() {
        ...
        return (error.formatted /* sass error messages have this */ ||
            error.message ||
    ...
    function getStyleErrorRange() {
        ...
        const position = typeof (error === null || error === void 0 ? void 0 : error.column) === 'number' && typeof (error === null || error === void 0 ? void 0 : error.line) === 'number'
...
function getScriptErrorDiagnostics(error, document) {
    ...
    function getScriptErrorRange() {
        var _a, _b;
        const position = ((_a = document.scriptInfo) === null || _a === void 0 ? void 0 : _a.startPos) || ((_b = document.moduleScriptInfo) === null || _b === void 0 ? void 0 : _b.startPos) ||
...
function isNoFalsePositive(diag, doc) {
    ...
    const hasExportedEnumWithThatName = new RegExp(`\\bexport\\s+?enum\\s+?${unusedExportName}\\b`).test(doc.getText());
