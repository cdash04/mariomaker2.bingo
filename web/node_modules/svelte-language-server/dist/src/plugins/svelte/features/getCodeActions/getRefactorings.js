...
async function executeExtractComponentCommand(svelteDoc, refactorArgs) {
    ...
    return {
        documentChanges: [
            vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.VersionedTextDocumentIdentifier.create(svelteDoc.uri, null), [
    ...
    function createNewFileEdit() {
        ...
        const newText = [
            ...
            .map((tag) => tag.text)
            .join('');
        return vscode_languageserver_1.TextDocumentEdit.create(vscode_languageserver_1.VersionedTextDocumentIdentifier.create(newFileUri, null), [
            vscode_languageserver_1.TextEdit.insert(vscode_languageserver_1.Position.create(0, 0), newText),
        ]);
