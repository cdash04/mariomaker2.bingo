...
class SveltePlugin {
    ...
    async getDiagnostics(document) {
        ...
        return getDiagnostics_1.getDiagnostics(document, await this.getSvelteDoc(document), this.configManager.getConfig().svelte.compilerWarnings);
    }
    ...
    async formatDocument(document, options) {
        ...
        const config = returnObjectIfHasKeys(await prettier.resolveConfig(filePath, { editorconfig: true })) ||
        ...
        const fileInfo = await prettier.getFileInfo(filePath, {
            ignorePath: (_b = (_a = this.prettierConfig) === null || _a === void 0 ? void 0 : _a.ignorePath) !== null && _b !== void 0 ? _b : '.prettierignore',
        });
        if (fileInfo.ignored) {
