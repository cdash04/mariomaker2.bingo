...
const webCustomData_1 = require("vscode-html-languageservice/lib/umd/languageFacts/data/webCustomData");
const svelteEvents = [
    ...webCustomData_1.htmlData.globalAttributes.map(mapToSvelteEvent),
    {
        name: 'on:introstart',
...
const html5Tags = webCustomData_1.htmlData.tags.map(tag => {
...
exports.svelteHtmlDataProvider = vscode_html_languageservice_1.newHTMLDataProvider('svelte-builtin', {
    version: 1,
    globalAttributes: [...webCustomData_1.htmlData.globalAttributes, ...svelteEvents, ...svelteAttributes],
    tags: [...html5Tags, ...svelteTags],
    valueSets: webCustomData_1.htmlData.valueSets,
});
