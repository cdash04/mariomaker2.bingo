import { CodeAction, CodeActionContext, Color, ColorInformation, ColorPresentation, CompletionList, DefinitionLink, Diagnostic, Hover, Position, Range, SymbolInformation, TextDocumentIdentifier, TextEdit, FileChangeType, CompletionItem, CompletionContext, WorkspaceEdit, FormattingOptions, ReferenceContext, Location } from 'vscode-languageserver';
