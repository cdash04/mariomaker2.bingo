...
exports.getWordAt = exports.getNodeIfIsInComponentStartTag = exports.updateRelativeImport = exports.getLineAtPosition = exports.getTextInRange = exports.isRangeInTag = exports.isInTag = exports.offsetAt = exports.positionAt = exports.extractStyleTag = exports.extractScriptTags = exports.parseHtml = void 0;
...
function extractTags(text, tag, html) {
    ...
    const rootNodes = (html === null || html === void 0 ? void 0 : html.roots) || parseHtml(text).roots;
