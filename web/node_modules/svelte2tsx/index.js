...
var compiler = _interopDefault(require('svelte/compiler'));
var dedent = _interopDefault(require('dedent-js'));
        ...
        const handleTypeAssertion = (declaration) => {
            ...
            if (!ts.isIdentifier(identifier) ||
                (!type &&
                    ...
                    ![ts.SyntaxKind.FalseKeyword, ts.SyntaxKind.TrueKeyword].includes((_a = declaration.initializer) === null || _a === void 0 ? void 0 : _a.kind))) {
                return;
            }
...
function classNameFromFilename(filename) {
    ...
    try {
        ...
        const inPascalCase = pascalCase.pascalCase(withoutExtensions);
